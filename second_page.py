...
class SecondPage(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.gambarAbout = QtWidgets.QGraphicsView(self.centralwidget)
        self.gambarAbout.setGeometry(QtCore.QRect(100, 90, 201, 141))
        self.gambarAbout.setObjectName("gambarAbout")
